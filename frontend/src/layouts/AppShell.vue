<template>
  <div class="flex h-screen overflow-hidden">
              ...
              <TooltipTrigger as-child>
                <div class="flex items-center">
                  ...
                  >
                    ...
                    />
                    <span
                      class="hidden font-medium sm:inline capitalize text-foreground"
                      >{{
                        healthStatus === "healthy"
                          ? "Healthy"
                          : healthStatus === "degraded"
              ...
              <TooltipContent>
                <div class="flex flex-col gap-1">
                  ...
                  <div class="flex justify-between gap-4 text-xs">
                    ...
                    <span class="text-popover-foreground">{{
                      apiVersion
                    }}</span>
                  </div>
                  <div class="flex justify-between gap-4 text-xs">
    ...
    <!-- Log Viewer Panel -->
    <LogViewerPanel v-if="false" :is-open="isLogsOpen" @close="toggleLogs" />
  </div>
</template>
...
import LogViewerPanel from "@/components/layout/LogViewerPanel.vue";
...
const apiPythonVersion = ref<string>("");
const apiUptime = ref<number | null>(null);
...
const checkApiHealth = async () => {
  try {
    ...
    apiPythonVersion.value = response.pythonVersion || "N/A";
    apiUptime.value = response.uptimeSeconds || null;
    ...
    apiTimestamp.value = new Date().toLocaleString(undefined, {
      dateStyle: "short",
      timeStyle: "medium",
    });
    apiPythonVersion.value = "N/A";
    apiUptime.value = null;
  }
};
